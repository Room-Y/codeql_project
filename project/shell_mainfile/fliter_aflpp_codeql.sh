...
do
    ...
    (
        ...
        shell_remove_copy="AFLPP1_shell_copy_remove_"$proj
        shell_remove_json="shell_json_remove_"$proj
        shell_remove_exec="AFLPP1_shell_exec_remove_"$proj
        remove_fuzz="AFLPP1_remove_fuzz"

        # shell_remove_copy="shell_copy_remove_"$proj
        # shell_remove_json="shell_json_remove_"$proj
        # shell_remove_exec="shell_exec_remove_"$proj
        # remove_fuzz="remove_fuzz"
